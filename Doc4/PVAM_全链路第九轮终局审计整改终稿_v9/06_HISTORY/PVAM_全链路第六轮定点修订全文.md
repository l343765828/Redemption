...
<!-- SOURCE: 00_F5-01-F5-08_真实性核验与反驳表.md -->
...
<!-- SOURCE: 01_PLAN/Redemption_PV_Amount_Migration_d74_检查方案_v1.15.md -->
...
<!-- SOURCE: 02_REPORT/REPORT-PVAM-v1.5.md -->
...
<!-- SOURCE: 03_MODPLAN/MODPLAN-PVAM_v1.2_终稿修改方案套件/MODPLAN-PVAM_v1.2_完整套件全文.md -->

# MODPLAN-PVAM v1.2 完整套件全文

---

<!-- SOURCE: MODPLAN-PVAM_v1.2_总方案.md -->
...
| F5-01～F5-08 五轮核验 | `00_F5-01-F5-08_真实性核验与反驳表.md` |
| 编制角色 | 高级技术架构师 / 研发负责人 |
| 编制日期 | `2026-08-04` |
| 审批人 | `待组织授权人签署` |
| 审批日期 | `待签署` |
...
| 文件 | 作用 |
|---|---|
| `00_F5-01-F5-08_真实性核验与反驳表.md` | 当前五轮审计意见独立裁决 |
...
本文件当前治理状态为 `DRAFT`，授权状态为 `PENDING_ORGANIZATIONAL_APPROVAL`。当前会话指令授权的是 F5-01～F5-08 的事实核验和文档/控制资产修订，不是代码施工、部署或生产发布授权。
...
<!-- SOURCE: TASK-PVAM-01_金额编码公共层与基础模型适配器.md -->
...
<!-- SOURCE: TASK-PVAM-02_订单退款入口金额放大与边界转换.md -->
...
| 所属总方案 | `MODPLAN-PVAM_v1.2` |
| 任务编号 | `TASK-PVAM-02` |
| 来源检查项 | `CHK-DATA-001、CHK-DATA-002、CHK-ARCH-003、CHK-BIZ-011、CHK-DATA-005、CHK-EVT-001、CHK-EVT-002、CHK-TEST-002` |
| 来源问题 | `R-003、R-007` |
| 处置项 | `REM-003、REM-007` |
| 施工项 | `W-003、W-007` |
| 验证项 | `V-003、V-007` |
...
<!-- SOURCE: TASK-PVAM-03_配置解析ppm与硬编码清理.md -->
...
| 所属总方案 | `MODPLAN-PVAM_v1.2` |
| 任务编号 | `TASK-PVAM-03` |
| 来源检查项 | `CHK-DATA-004、CHK-BIZ-004、CHK-BIZ-007、CHK-BIZ-008、CHK-TEST-002` |
| 来源问题 | `R-004` |
| 处置项 | `REM-004` |
| 施工项 | `W-004` |
| 验证项 | `V-004` |
...
<!-- SOURCE: TASK-PVAM-04_monthActivePV与Active同源现算.md -->
...
| 所属总方案 | `MODPLAN-PVAM_v1.2` |
| 任务编号 | `TASK-PVAM-04` |
| 来源检查项 | `CHK-DATA-006、CHK-BIZ-007、CHK-BIZ-008、CHK-BIZ-009、CHK-BIZ-011、CHK-PUB-002` |
| 来源问题 | `R-005、R-006` |
| 处置项 | `REM-005、REM-006` |
| 施工项 | `W-005、W-006` |
| 验证项 | `V-005、V-006` |
...
<!-- SOURCE: TASK-PVAM-05_Elite_SOURCE原子性与Writer_Proof.md -->
...
<!-- SOURCE: TASK-PVAM-06_全量重算状态机发布分层与统一Guard.md -->
...
| 所属总方案 | `MODPLAN-PVAM_v1.2` |
| 任务编号 | `TASK-PVAM-06` |
| 来源检查项 | `CHK-BIZ-006、CHK-ARCH-002、CHK-EVT-003、CHK-EVT-004、CHK-PUB-001、CHK-TEST-003` |
| 来源问题 | `R-009、R-010`；条件性承接 `RISK-001` |
| 处置项 | `REM-009、REM-010` |
| 施工项 | `W-009、W-010` |
| 验证项 | `V-009、V-010` |
| 条件工作项 | `TOPO-WIRE-01（关联 RISK-001 / DEC-012）` |
...
<!-- SOURCE: TASK-PVAM-07A_Consumer_ACK紧急修复.md -->
...
<!-- SOURCE: TASK-PVAM-07B_事件路由与Stream保留.md -->
...
<!-- SOURCE: TASK-PVAM-08_风险延期与UAT准入证据包.md -->
...
| 所属总方案 | `MODPLAN-PVAM_v1.2` |
| 任务编号 | `TASK-PVAM-08` |
| 来源检查项 | `CHK-ARCH-001、CHK-ARCH-002、CHK-DATA-007、CHK-BIZ-002、CHK-PUB-001、CHK-PUB-002、CHK-TEST-001～004` |
| 来源问题 | `RISK-001、RISK-002、UV-001～UV-005` |
| 处置项 | `RISK/UV；OPT-001、OPT-002` |
| 施工项 | `UAT/证据施工项` |
| 验证项 | `UAT-001～UAT-012` |
| 派生缺口 | `GAP-DEC004-2B / DEFERRED` |
| 关联决策 | `DEC-009、DEC-010、DEC-012、DEC-013、DEC-015、DEC-017` |
| 严重级别 | `P0 / P1` |
| 当前状态 | `DRAFT` |
| 受控基线 | `l343765828/Redemption@2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb` |
| 编制日期 | `2026-08-04` |
...
<!-- SOURCE: 04_WORKPLAN/WORK-PLAN-PVAM_v1.3_终稿施工方案套件/WORK-PVAM_v1.3_完整套件全文.md -->

# WORK-PLAN-PVAM v1.3 完整套件全文

---

<!-- SOURCE: WORK-PLAN-PVAM_v1.3_施工总方案.md -->
...
| 五轮审查 | `F5-01～F5-08` 独立核验与第六轮定点修订 |
| 项目代码基线 | `l343765828/Redemption@2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb` |
| 修改方案套件SHA-256 | `cee75c5f79e27936aa8fac5a011315b608cc7b70cad56f0c8a85c43082145e0a`（对象：`MODPLAN-PVAM_v1.2_终稿修改方案套件.zip`，随本包提供） |
...
| 6 | `WORK-PVAM-06` | `TASK-PVAM-06` | R-009、R-010；条件性承接 RISK-001 / TOPO-WIRE-01 | DEC-007、DEC-008、DEC-010、DEC-012 | 全量重算状态机、统一 Guard 与发布分层 | WORK-PVAM-01、WORK-PVAM-02、WORK-PVAM-05 DEV_VERIFIED；WORK-08A调用图证据可并行 | 否 | BLOCKED |
...
| 9 | `WORK-PVAM-08` | `TASK-PVAM-08` | RISK-001、RISK-002、UV-001～UV-005、OPT-001、OPT-002 | DEC-009、DEC-010、DEC-012、DEC-013、DEC-015、DEC-017 | 风险、UAT 准入与机器可读证据包 | 阶段A可与所有DEV任务并行；阶段B依赖DEC-013及WORK-01～07B DEV_VERIFIED | 是 | BLOCKED |
...
本施工方案套件当前结论：`DRAFT / GATED`。F5-01～F5-07 的文档与控制脚本内部问题已按五轮审计意见修订并执行正/负向自测；F5-08 组织授权及以下外部施工门禁仍未满足：
...
<!-- SOURCE: WORK-PVAM-01_金额编码公共层与基础模型适配器.md -->
...
| TC-PVAM-01-02 | 单元 | 非法输入 | `0.1`,`True`,`"1e2"`,`"NaN"`,`"Infinity"` | 分别抛受控异常；无返回units | STEP-01-01 | DEV | NOT_RUN |
...
| EV-PVAM-01-06 | AC-06验收证据：`0.1` float、`True`、NaN、Infinity、指数文本均被相应用例拒绝 | STEP-PVAM-01-01/05 | evidence/WORK-PVAM-01/attempt-*/ac/AC-06/ | 待指派QA | PENDING |
...
<!-- SOURCE: WORK-PVAM-02_订单退款金额边界与期间解析.md -->
...
```text
CHK-DATA-001、CHK-DATA-002、CHK-ARCH-003、CHK-BIZ-011、CHK-DATA-005、CHK-EVT-001、CHK-EVT-002、CHK-TEST-002
  └─ R-003、R-007
...
| 检查方案 | `PLAN-PVAM-v1.15` | CHK-DATA-001、CHK-DATA-002、CHK-ARCH-003、CHK-BIZ-011、CHK-DATA-005、CHK-EVT-001、CHK-EVT-002、CHK-TEST-002 | CONTROLLED |
...
| 影响 | 金额/PV单位、奖金、并发一致性、发布或可恢复性，具体见来源问题。 |
| 严重级别 | P0 |
| 证据位置 | 固定代码基线 `2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb`；来源 `TASK-PVAM-02`；检查项 `CHK-DATA-001、CHK-DATA-002、CHK-ARCH-003、CHK-BIZ-011、CHK-DATA-005、CHK-EVT-001、CHK-EVT-002、CHK-TEST-002` |
...
<!-- SOURCE: WORK-PVAM-03_配置解析ppm与硬编码清理.md -->
...
```text
CHK-DATA-004、CHK-BIZ-004、CHK-BIZ-007、CHK-BIZ-008、CHK-TEST-002
  └─ R-004
...
| 检查方案 | `PLAN-PVAM-v1.15` | CHK-DATA-004、CHK-BIZ-004、CHK-BIZ-007、CHK-BIZ-008、CHK-TEST-002 | CONTROLLED |
...
| 影响 | 金额/PV单位、奖金、并发一致性、发布或可恢复性，具体见来源问题。 |
| 严重级别 | P0 |
| 证据位置 | 固定代码基线 `2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb`；来源 `TASK-PVAM-03`；检查项 `CHK-DATA-004、CHK-BIZ-004、CHK-BIZ-007、CHK-BIZ-008、CHK-TEST-002` |
...
<!-- SOURCE: WORK-PVAM-04_monthActivePV与Active同源现算.md -->
...
```text
CHK-DATA-006、CHK-BIZ-007、CHK-BIZ-008、CHK-BIZ-009、CHK-BIZ-011、CHK-PUB-002
  └─ R-005、R-006
...
| 检查方案 | `PLAN-PVAM-v1.15` | CHK-DATA-006、CHK-BIZ-007、CHK-BIZ-008、CHK-BIZ-009、CHK-BIZ-011、CHK-PUB-002 | CONTROLLED |
...
| 影响 | 金额/PV单位、奖金、并发一致性、发布或可恢复性，具体见来源问题。 |
| 严重级别 | P0 / P1 |
| 证据位置 | 固定代码基线 `2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb`；来源 `TASK-PVAM-04`；检查项 `CHK-DATA-006、CHK-BIZ-007、CHK-BIZ-008、CHK-BIZ-009、CHK-BIZ-011、CHK-PUB-002` |
...
<!-- SOURCE: WORK-PVAM-05_Elite_SOURCE原子提交与发布批次.md -->
...
<!-- SOURCE: WORK-PVAM-06_结算状态机统一Guard与Topology接线.md -->
...
1. 上游修改任务与本 v1.3 施工套件当前均为 `DRAFT`；没有组织授权前，本任务保持 `BLOCKED`，不得启动代码施工或部署。
2. 只实施 `R-009、R-010；条件性承接 RISK-001 / TOPO-WIRE-01` 中已 `ACCEPTED` 或由来源 TASK 明确批准的条件代码事项。任何 `REJECTED / NEEDS_DECISION / DEFERRED / 未获 TASK 授权的 UAT_VERIFY` 只允许登记、验证或阻断，不得扩展代码范围。
...
| 来源问题 | `R-009、R-010；条件性承接 RISK-001 / TOPO-WIRE-01` |
...
```text
CHK-BIZ-006、CHK-ARCH-002、CHK-EVT-003、CHK-EVT-004、CHK-PUB-001、CHK-TEST-003
  └─ R-009、R-010；条件性承接 RISK-001 / TOPO-WIRE-01
...
| 输入 | 编号/版本 | 本任务使用的结论 | 状态 |
|---|---|---|---|
| 复核报告 | `Redemption_PV_Amount_Migration_d74_复核报告_v1.5` | R-009、R-010；条件性承接 RISK-001 / TOPO-WIRE-01 的代码事实与严重级别 | CONFIRMED |
| 修改任务书 | `TASK-PVAM-06` | 采用方案、范围、排除项、AC | DRAFT（待组织授权） |
| 检查方案 | `PLAN-PVAM-v1.15` | CHK-BIZ-006、CHK-ARCH-002、CHK-EVT-003、CHK-EVT-004、CHK-PUB-001、CHK-TEST-003 | CONTROLLED |
...
| 影响 | 金额/PV单位、奖金、并发一致性、发布或可恢复性，具体见来源问题。 |
| 严重级别 | P0 |
| 证据位置 | 固定代码基线 `2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb`；来源 `TASK-PVAM-06`；检查项 `CHK-BIZ-006、CHK-ARCH-002、CHK-EVT-003、CHK-EVT-004、CHK-PUB-001、CHK-TEST-003` |
...
<!-- SOURCE: WORK-PVAM-07A_Consumer_ACK紧急修复.md -->
...
<!-- SOURCE: WORK-PVAM-07B_事件路由与Stream保留.md -->
...
<!-- SOURCE: WORK-PVAM-08_UAT准入与证据治理.md -->
...
| 来源问题 | `RISK-001、RISK-002、UV-001～UV-005、OPT-001、OPT-002` |
...
```text
CHK-ARCH-001、CHK-ARCH-002、CHK-DATA-007、CHK-BIZ-002、CHK-PUB-001、CHK-PUB-002、CHK-TEST-001～004
  └─ RISK-001、RISK-002、UV-001～UV-005、OPT-001、OPT-002
       └─ DEC-009、DEC-010、DEC-012、DEC-013、DEC-015、DEC-017
...
| 输入 | 编号/版本 | 本任务使用的结论 | 状态 |
|---|---|---|---|
| 复核报告 | `Redemption_PV_Amount_Migration_d74_复核报告_v1.5` | RISK-001、RISK-002、UV-001～UV-005、OPT-001、OPT-002 的代码事实与严重级别 | CONFIRMED |
| 修改任务书 | `TASK-PVAM-08` | 采用方案、范围、排除项、AC | DRAFT（待组织授权） |
| 检查方案 | `PLAN-PVAM-v1.15` | CHK-ARCH-001、CHK-ARCH-002、CHK-DATA-007、CHK-BIZ-002、CHK-PUB-001、CHK-PUB-002、CHK-TEST-001～004 | CONTROLLED |
| 正式决策 | DEC-009、DEC-010、DEC-012、DEC-013、DEC-015、DEC-017 | 只执行已关闭裁决；开放项阻断 | CLOSED / 按上游登记 |
| 代码/SQL快照 | 2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb | 唯一施工对象 | FROZEN |
| 施工模板 | 总方案模板/专项模板 | 章节、状态、证据纪律 | CONTROLLED |
...
| 影响 | 金额/PV单位、奖金、并发一致性、发布或可恢复性，具体见来源问题。 |
| 严重级别 | P0 / P1 / 优化 |
| 证据位置 | 固定代码基线 `2475c6c49e60089b28f8ef1c0b75e86b2ceb6ebb`；来源 `TASK-PVAM-08`；检查项 `CHK-ARCH-001、CHK-ARCH-002、CHK-DATA-007、CHK-BIZ-002、CHK-PUB-001、CHK-PUB-002、CHK-TEST-001～004` |
...
<!-- SOURCE: 05_CONTROL/validate_traceability_v3.py -->

# `05_CONTROL/validate_traceability_v3.py`

```python
#!/usr/bin/env python3
"""Validate the PVAM five-layer traceability contract.
...
def main() -> None:
    ...
    for row in core_edges:
        ...
        if issue not in tasks[task_id].source_issues or issue not in works[work_id].source_issues:
            fail(f"issue edge {issue} missing from TASK/WORK metadata")
        if not set(row.get("checks", [])) <= tasks[task_id].source_checks:
            fail(f"{issue} checks not contained by {task_id}")
        if not set(row.get("checks", [])) <= works[work_id].source_checks:
            fail(f"{issue} checks not contained by {work_id}")
        if not set(row.get("decisions", [])) <= tasks[task_id].decisions:
            fail(f"{issue} decisions not contained by {task_id}")
        if not set(row.get("decisions", [])) <= works[work_id].decisions:
    ...
    for row in non_core:
        ...
        if work_id is None and task_id is None:
            continue
        if work_id not in works or task_id not in tasks:
            fail(f"unknown non-core task/work edge: {row['item_id']}")
        aggregate_steps[work_id].update(row.get("steps", []))
        aggregate_tests[work_id].update(row.get("local_tests", []))
        aggregate_evidences[work_id].update(row.get("evidences", []))
...
<!-- SOURCE: 05_CONTROL/TRACEABILITY_MANIFEST.json -->
...
<!-- SOURCE: 05_CONTROL/WORK_SCOPE_ALLOWLIST.json -->

# `05_CONTROL/WORK_SCOPE_ALLOWLIST.json`
  ...
  "works": {
    "WORK-PVAM-01": {
      "exact": [
        ...
        "Model/User/UserStats.py",
        "Model/User/EliteBonusStats.py",
        "User/UserStatsService.py",
        "User/GlobalRecalculationService.py",
        ...
        "User/Test/test_pv_amount_common.py",
        "User/Test/test_amount_model_version.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-01/"
      ],
      "prerequisites": []
    },
    "WORK-PVAM-02": {
    ...
    "WORK-PVAM-03": {
      "exact": [
        "Common/BonusConfig.py",
        "Model/Config/ConfigSnapshot.py",
        "User/PEBonusService.py",
        "User/EliteBonusService.py",
        "User/GlobalEliteBonusRecalculationService.py",
        "User/SuperEliteBonusService.py",
        "User/LeadershipBonusGPUService.py",
        "User/EliteAchievementBonusService.py",
        "User/team_bonus_tb.py",
        "User/Test/test_bonus_config.py",
        "User/Test/test_team_bonus_tb.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-03/"
      ],
      "prerequisites": [
        "WORK-PVAM-01"
      ]
    ...
    "WORK-PVAM-04": {
      "exact": [
        "Common/MonthActivePvProvider.py",
        "Common/ActiveRule.py",
        "User/PEBonusService.py",
        "User/SuperEliteBonusService.py",
        "User/LeadershipBonusGPUService.py",
        "User/EliteAchievementBonusService.py",
        "User/run_monthly_bonus_pipeline_v2.py",
        "User/Test/test_month_active_pv.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-04/"
      ],
      "prerequisites": [
        "WORK-PVAM-01",
        "WORK-PVAM-03"
    ...
    "WORK-PVAM-05": {
      "exact": [
        "Model/User/EliteSourceAssignment.py",
        "User/EliteRedisCommit.py",
        "User/EliteBonusCandidateBuilder.py",
        "User/EliteBonusPublishBatch.py",
        "User/EliteBonusService.py",
        "User/GlobalEliteBonusRecalculationService.py",
        "User/Test/test_elite_atomic_commit.py",
        "User/Test/test_elite_publish_batch.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-05/"
      ],
      "prerequisites": [
        "WORK-PVAM-01",
        "WORK-PVAM-02",
    ...
    "WORK-PVAM-06": {
      "exact": [
        "Settlement/SettlementRunManifest.py",
        "Settlement/SettlementGuard.py",
        "Settlement/SettlementCoordinator.py",
        "User/GlobalRecalculationService.py",
        "User/GlobalEliteBonusRecalculationService.py",
        "User/PlacementRecalculationService.py",
        "User/UserStatsService.py",
        "User/TopologyMutationService.py",
        "MessageConsumer/UserConsumer.py",
        "MessageConsumer/PvEventConsumer.py",
        "User/Test/test_settlement_coordinator.py",
        "User/Test/test_settlement_guard.py",
        "User/Test/test_topology_mutation_wiring.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-06/"
      ],
      "prerequisites": [
        "WORK-PVAM-01",
        "WORK-PVAM-02",
    ...
    "WORK-PVAM-07A": {
      "exact": [
        "MessageConsumer/RecalcProcessResult.py",
        "MessageConsumer/RecalcStreamConsumer.py",
        "MessageConsumer/Test/test_recalc_ack_fail_closed.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-07A/"
      ],
      "prerequisites": []
    },
    "WORK-PVAM-07B": {
      "exact": [
        "MessageConsumer/RecalcEventSchema.py",
        "MessageConsumer/RecalcHandlerRegistry.py",
        "MessageConsumer/RecalcDisposition.py",
        "Settlement/RecalcEventPublisher.py",
        "Ops/RecalcStreamRetention.py",
        "MessageConsumer/RecalcStreamConsumer.py",
        "User/GlobalRecalculationService.py",
        "User/GlobalEliteBonusRecalculationService.py",
        "User/PlacementRecalculationService.py",
        "User/PlacementIncrementalService.py",
        "MessageConsumer/Test/test_recalc_event_v2.py",
        "MessageConsumer/Test/test_stream_retention.py"
      ],
      "prefixes": [
        "tests/pvam/WORK-PVAM-07B/"
      ],
      "prerequisites": [
        "WORK-PVAM-06",
        "WORK-PVAM-07A"
...
<!-- SOURCE: 05_CONTROL/validate_work_dev.sh -->
...
usage() {
  cat >&2 <<'EOF'
usage: validate_work_dev.sh \
  --repo REPO --base SHA --parent-commit SHA --parent-tree TREEISH \
  --parent-provenance FILE --work-commit SHA --work-id ID \
  --scope JSON --test-command-file FILE --out DIR [--stage A|B]
EOF
  exit 64
}

REPO= BASE= PARENT_COMMIT= PARENT_TREE= PARENT_PROVENANCE=
...
while (($#)); do
  case "$1" in
    ...
    --parent-provenance) PARENT_PROVENANCE=$2; shift 2 ;;
    --work-commit) WORK_COMMIT=$2; shift 2 ;;
    --work-id) WORK_ID=$2; shift 2 ;;
    --scope) SCOPE=$2; shift 2 ;;
    --test-command-file) TEST_FILE=$2; shift 2 ;;
    --out) OUT=$2; shift 2 ;;
...
[[ -n "$REPO" && -n "$BASE" && -n "$PARENT_COMMIT" && -n "$PARENT_TREE" && \
   -n "$PARENT_PROVENANCE" && -n "$WORK_COMMIT" && -n "$WORK_ID" && \
   -n "$SCOPE" && -n "$TEST_FILE" && -n "$OUT" ]] || usage

ROOT=$(git -C "$REPO" rev-parse --show-toplevel)
CONTROL_DIR=$(cd "$(dirname "$0")" && pwd)
OUT_DIR=$(mkdir -p "$OUT" && cd "$OUT" && pwd)
...
PATCH_ARGS=(
  ...
  --work-commit "$WORK_COMMIT"
  --work-id "$WORK_ID"
  --scope "$SCOPE"
  --out "$PATCH_OUT"
)
if [[ -n "$STAGE" ]]; then
  PATCH_ARGS+=(--stage "$STAGE")
fi
bash "$CONTROL_DIR/validate_work_patch.sh" "${PATCH_ARGS[@]}"

PATCH="$PATCH_OUT/${WORK_ID}.patch"
TMP_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/pvam-dev.XXXXXX")
TREE="$TMP_ROOT/tree"
cleanup() {
  if git -C "$ROOT" worktree list --porcelain | grep -Fqx "worktree $TREE"; then
...
PARENT_COMMIT_SHA=$(git -C "$ROOT" rev-parse "$PARENT_COMMIT^{commit}")
PARENT_TREE_SHA=$(git -C "$ROOT" rev-parse "$PARENT_TREE^{tree}")
WORK_SHA=$(git -C "$ROOT" rev-parse "$WORK_COMMIT^{commit}")
WORK_TREE_SHA=$(git -C "$ROOT" rev-parse "$WORK_SHA^{tree}")

git -C "$ROOT" worktree add --detach "$TREE" "$PARENT_COMMIT_SHA" >/dev/null
git -C "$TREE" apply --index "$PATCH"
EXPECTED_APPLIED_TREE=$(git -C "$TREE" write-tree)
[[ "$EXPECTED_APPLIED_TREE" == "$WORK_TREE_SHA" ]] || {
  echo "pre-test tree mismatch: $EXPECTED_APPLIED_TREE != $WORK_TREE_SHA" >&2
  exit 22
}

PY_LIST="$OUT_DIR/changed_python_files.txt"
awk 'NF && $0 ~ /\.py$/ {print}' "$PATCH_OUT/changed_files.txt" > "$PY_LIST"
PY_FILES=()
...
for file in "${PY_FILES[@]}"; do
  if [[ -f "$TREE/$file" ]]; then
    mkdir -p "$OUT_DIR/pycache"
    PYTHONPYCACHEPREFIX="$OUT_DIR/pycache" python -m py_compile "$TREE/$file"
  fi
done

PVAM_PATCH_SHA256=$(sha256sum "$PATCH" | awk '{print $1}')
PVAM_PARENT_PROVENANCE_SHA256=$(sha256sum "$PARENT_PROVENANCE" | awk '{print $1}')
(
  cd "$TREE"
  export PVAM_BASE_SHA="$BASE_SHA"
  export PVAM_PARENT_COMMIT_SHA="$PARENT_COMMIT_SHA"
  export PVAM_PARENT_TREE_SHA="$PARENT_TREE_SHA"
  export PVAM_PARENT_PROVENANCE_SHA256
  export PVAM_WORK_COMMIT_SHA="$WORK_SHA"
  export PVAM_WORK_TREE_SHA="$WORK_TREE_SHA"
  export PVAM_PATCH_SHA256
  export PVAM_EVIDENCE_DIR="$OUT_DIR"
...
git -C "$TREE" diff --exit-code -- . > "$OUT_DIR/post_test_unstaged_diff.txt"
git -C "$TREE" ls-files --others --exclude-standard > "$OUT_DIR/post_test_untracked.txt"
[[ ! -s "$OUT_DIR/post_test_untracked.txt" ]] || {
  echo "tests created untracked files" >&2
  cat "$OUT_DIR/post_test_untracked.txt" >&2
  exit 21
}
APPLIED_TREE=$(git -C "$TREE" write-tree)
[[ "$APPLIED_TREE" == "$WORK_TREE_SHA" ]] || {
  echo "tests changed applied tree" >&2
  exit 22
}

PROVENANCE_FIELDS_JSON=$(python - "$PATCH_OUT/parent_provenance_validation.json" <<'PYJSON'
import json, sys
from pathlib import Path
data = json.loads(Path(sys.argv[1]).read_text(encoding='utf-8'))
result = {
    "direct_prerequisites": data.get("direct_prerequisites", []),
    "prerequisite_closure": data.get("prerequisite_closure", []),
    "integration_order": data.get("integration_order", []),
    "included_works": data.get("included_works", []),
}
print(json.dumps(result, ensure_ascii=False, separators=(',', ':')))
PYJSON
)
CHANGED_PY_JSON=$(python - "$PY_LIST" <<'PY'
import json, sys
from pathlib import Path
lines = [line.strip() for line in Path(sys.argv[1]).read_text(encoding='utf-8').splitlines() if line.strip()]
print(json.dumps(lines, ensure_ascii=False, separators=(',', ':')))
PY
)
if [[ -n "$STAGE" ]]; then STAGE_JSON="\"$STAGE\""; else STAGE_JSON=null; fi
cat > "$OUT_DIR/dev_validation.json" <<JSON
{
  ...
  "parent_provenance_sha256": "$PVAM_PARENT_PROVENANCE_SHA256",
  "parent_provenance": $PROVENANCE_FIELDS_JSON,
  "work_commit_sha": "$WORK_SHA",
  "work_tree_sha": "$WORK_TREE_SHA",
  "patch_sha256": "$PVAM_PATCH_SHA256",
  "applied_tree_hash": "$APPLIED_TREE",
  "changed_python_files": $CHANGED_PY_JSON,
  "test_exit": 0,
  "validation_status": "PASS"
}
JSON

echo "DEV_VALIDATION_PASS $WORK_ID $WORK_SHA parent_commit=$PARENT_COMMIT_SHA parent_tree=$PARENT_TREE_SHA"
```
